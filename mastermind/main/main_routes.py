...
# Game create routes
main_bp.add_url_rule("/new-game",
                     view_func=New_Game_Controller.as_view("new_game", player_model, game_model),
                     methods=["GET"])
main_bp.add_url_rule("/new-game",
                     view_func=New_Game_Controller.as_view("new_game_create", player_model, game_model),
                     methods=["POST"])

# Game routes
main_bp.add_url_rule("/game",
                     view_func=Game_Controller.as_view("game", player_model, game_model),
                     methods=["GET"])
main_bp.add_url_rule("/game",
                     view_func=Game_Controller.as_view("game_update", player_model, game_model),
                     methods=["POST"])

# Users overview routes
main_bp.add_url_rule("/users-overview",
                     view_func=Usersoverview_Controller.as_view("users_overview", player_model, game_model),
                     methods=["GET"])

# User overview routs
main_bp.add_url_rule("/user-overview/<id>",
                     view_func=Useroverview_Controller.as_view("user_overview", player_model, game_model),
                     methods=["GET"])
